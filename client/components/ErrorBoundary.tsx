  ...
  render() {
    if (this.state.hasError) {
      ...
      const isContextError = this.state.error?.message.includes(
        "useSTL must be used within an STLProvider",
      );
            ...
            <Alert variant="destructive" className="mb-4">
              ...
              <AlertDescription className="mt-2 space-y-2">
                {isContextError ? (
                  <div>
                    <p>
                      The application context was not properly initialized. This
                      can happen during development or page reloads.
                    </p>
                    <p className="text-sm mt-2">
                      Try refreshing the page or clicking the reset button
                      below.
                    </p>
                  </div>
                ) : (
              ...
              <Alert className="mt-4">
                <AlertDescription>
                  <div className="text-xs">
                    ...
                    helping catch context initialization issues. If you see this
                    repeatedly, try:
                    <ul className="list-disc ml-4 mt-1">
                      <li>Refreshing the page</li>
                      <li>
                        Checking the browser console for additional errors
                      </li>
...
export const STLErrorBoundary: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
