...
export class PolygonGeometryBuilder {
  ...
  static createCrossShape(
    ...
    // Top and bottom faces - create single cross-shaped polygons (like cylinders)
    // This allows EdgeAdjacentMerger to work properly

    // Top face - single cross-shaped polygon
    faces.push(this.createFace([...topVertices], "polygon"));

    // Bottom face - single cross-shaped polygon (reversed for proper normal)
    faces.push(this.createFace([...bottomVertices].reverse(), "polygon"));
